            ...
            <form onSubmit={formSubmit}>
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="w-full mx-2 flex-1">
                        ...
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                            <input required name="fullname" onChange={InputEvent} placeholder="Enter Your Name" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
                        </div>
                    </div>
                    <div class="w-full mx-2 flex-1">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Email</div>
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                            <input required name="email" onChange={InputEvent} placeholder="Email Address" type='email' class="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
                        </div>
                    </div>
                </div>
                <div class="flex flex-col md:flex-row">
                    <div class="w-full mx-2 flex-1">
                        ...
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                            <input required name="phone" onChange={InputEvent} placeholder="03*********" type="number" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
                        </div>
                    </div>
                    <div class="w-full mx-2 flex-1">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Age</div>
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                            <input required name="age" onChange={InputEvent} placeholder="22" type="number" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
                        </div>
                    </div>
                </div>
                <div class="py-5 mx-3">
                    ...
                    >Bio : </label>
                    <textarea required onChange={InputEvent} placeholder="Enter Bio Details..." name="other" id="exampleFormControlTextarea1" class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none" rows="4"></textarea>
                </div>
                <div class="flex flex-col md:flex-row">
                    <div class="w-full mx-2 flex-1 relative">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> Gender</div>
                        <select required name="gender" onChange={InputEvent} class="block mt-2 appearance-none w-full bg-gray-200 border border-gray-200 py-2.5 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                    ...
                    <div class="w-full mx-2 flex-1 relative">
                        ...
                        <select required name="gender" onChange={InputEvent} class="block mt-2 appearance-none w-full bg-gray-200 border border-gray-200 py-2.5 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                            ...
                            <option value="male">Sindh</option>
                            <option value="male">Khyber Pakhtunkhwa</option>
                            <option value="male">Balochistan</option>
                        </select>
                        <div class="pointer-events-none absolute inset-y-0 right-0  top-10 flex items-center px-2 text-gray-700">
                            <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" /></svg>
                        </div>
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="w-full mx-2 flex-1">
                        ...
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                            <input required name="phone" onChange={InputEvent} placeholder="Enter City..." class="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
                        </div>
                    </div>
                    <div class="w-full mx-2 flex-1">
                        <div class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"> ZIP / Postal code</div>
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                            <input required name="age" onChange={InputEvent} placeholder="Enter Code..." type="number" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
                        </div>
                    </div>
                </div>
                <div class="flex flex-col md:flex-row">
                    <div class="w-full mx-2 flex-1">
                        ...
                        <div class="bg-white my-2 p-1 flex border border-gray-200 rounded">
                            <input required name="phone" onChange={InputEvent} placeholder="Enter Address..." class="p-1 px-2 appearance-none outline-none w-full text-gray-800" />
                        </div>
                    </div>
                </div>
