          ...
          ">
                        ...
                        <div>
                            ...
                            <div class="w-full flex-col gap-2 flex space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                                <a href="#" class="sm:w-auto ml-4 flex hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-start px-4 py-2.5 ">
                                ...
                                <a href="#" class="sm:w-auto ml-12 flex hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-start px-4 py-2.5 ">
