...
const mainTextnImage = () => {
    return (
        <div class="px-5 sm:mx-auto py-6 sm:py-8 overflow-x-hidden flex flex-col-reverse md:flex-row sm:justify-around sm:items-center">
            <div data-aos="fade-right" class="text-white py-4 text-xl sm:w-11/12 md:w-1/2 sm:text-4xl xl:mr-20 md:text-5xl font-serif"> <strong class="text-green-950"> Best Place</strong>, Where You Shop And Stitch Your Worth Cloths Tustedly...
            ...
            <div data-aos="fade-left" class=" pb-6 sm:pb-0 max-w-2xl self-center"><Image src={tailorImg} width={400} height={400}  alt="tailorImg" /></div>
        </div>
    )
}
