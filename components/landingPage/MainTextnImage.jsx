...
const mainTextnImage = () => {
    return (
        <div class="px-5  sm:max-w-7xl sm:mx-auto py-6 sm:py-8 flex flex-col-reverse md:flex-row sm:justify-around sm:items-center">
            <div class="text-white py-4  text-xl sm:w-11/12 md:w-1/2 lg:max-w-2xl sm:text-4xl md:text-5xl font-serif"> <strong class="text-green-950"> Best Place</strong>, Where You Shop And Stich Your Worth Cloths Tustedly...
            ...
            <div class=" pb-6 sm:pb-0 max-w-2xl self-center"><Image src={tailorImg} width={400} height={400}  alt="tailorImg" /></div>
        </div>
    )
}
