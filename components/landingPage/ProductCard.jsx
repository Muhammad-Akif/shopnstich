                                    ...
                                    <div class="w-52 lg:w-full h-auto overflow-hidden rounded-lg shadow-md bg-white hover:shadow-2xl transition-shadow duration-300 ease-in-out">
                                        <div className="card-wd ">
                                            ...
                                            <div class="px-5 w-52 lg:w-full">
                                                ...
                                                <div class="flex flex-col xl:flex-row justify-between items-center sm:mb-5">
                                                    <div class="text-xl font-bold text-gray-900 dark:text-white">Rs: 599</div>
                                                    <button class="text-white bg-orange-400 hover:bg-orange-300 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-1/2 p-2 sm:py-2.5 text-center"> 
                                                        View Details
                                                    </button>
                                                </div>
                                            </div>
