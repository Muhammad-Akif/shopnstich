...
const ProductCard = ({ category, setCart, cart, cloths }) => {
    ...
    return (
        <div class=''>
            <h1 class="text-green-960 whitespace-nowrap text-3xl sm:text-5xl font-bold font-serif p-12 text-center">
                                ...
                                <div class="px-2">
                                    <div class="w-full h-auto overflow-hidden rounded-lg shadow-md bg-white hover:shadow-2xl transition-shadow duration-300 ease-in-out">
                                        <div className="card-wd">
                                            ...
                                            <div class="px-5 pb-5">
                                                <a href="#">
                                                    <h3 class="text-lg sm:text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h3>
                                                </a>
                                                ...
                                                <div class="flex flex-col sm:flex-row justify-between items-center">
                                                    <div class="text-3xl font-bold text-gray-900 dark:text-white">$599</div>
                                                    <button onClick={()=> setCart(++cart)}  class="text-white bg-green-700 hover:bg-green-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full p-3 m-4 sm:px-5 sm:py-2.5 text-center">
                                                         Add to cart
                                                    </button>
                                                </div>
                                            </div>
