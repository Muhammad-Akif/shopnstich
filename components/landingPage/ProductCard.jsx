...
const ProductCard = () => {
    return (
        <div class="bg-gray-400">
            <h1 class="text-green-960 text-4xl font-bold font-serif p-12 text-center">
                Men Collections
            </h1>
            <div class="max-w-full px-12 pb-8 space-x-4 carousel carousel-center rounded-box">
                <div class="carousel-item w-1/4">
                    <div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="p-8 rounded-t-lg" src="https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg" />
                        </a>
                        <div class="px-5 pb-5">
                            <a href="#">
                ...
                <div class="carousel-item w-1/4">
                    <div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="p-8 rounded-t-lg" src="https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_.jpg" />
                        </a>
                        <div class="px-5 pb-5">
                            <a href="#">
                                <h3 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h3>
                ...
                <div class="carousel-item w-1/4">
                    <div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="p-8 rounded-t-lg" src="https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_.jpg" />
                        </a>
                        <div class="px-5 pb-5">
                            <a href="#">
                                <h3 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h3>
                ...
                <div class="carousel-item w-1/4">
                    <div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="p-8 rounded-t-lg" src="https://fakestoreapi.com/img/51Y5NI-I5jL._AC_UX679_.jpg" />
                        </a>
                        <div class="px-5 pb-5">
                            <a href="#">
                                <h3 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h3>
