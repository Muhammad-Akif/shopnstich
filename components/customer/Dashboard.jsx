...
const Dashboard = () => {
    ...
    return (
        <>
            ...
            {products?.length > 0 ? <div className="gap-8 grid sm:grid-cols-2 lg:grid-cols-3">{data?.map(RelatedProducts)}</div> : <div class='flex justify-center items-center text-red-500 font-bold text-xl py-5'> Comming Soon !</div>}
        </>
    )
}
